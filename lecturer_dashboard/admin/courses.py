...
class CoursesCustomAdminsite(admin.ModelAdmin):
    list_display = ['lecturer','subject','department','levels', 'semester']
    # list_display_links = ['*']
    list_form = '__all__'
...
lecturer_dashboard_site.register(MODEL, CoursesCustomAdminsite)
